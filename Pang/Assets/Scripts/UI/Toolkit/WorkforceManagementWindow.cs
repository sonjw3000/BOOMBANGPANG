	...
	public sealed class WorkforceManagementWindow : MonoBehaviour
	{
		...
		private static HandleGroup GetHandleGroup(WorkerTask.TaskType type)
		{
			return type switch
			{
				...
				WorkerTask.TaskType.Picking or WorkerTask.TaskType.Storing or WorkerTask.TaskType.PackingInput or WorkerTask.TaskType.PackingOutput or WorkerTask.TaskType.Packing or WorkerTask.TaskType.Labeling => HandleGroup.Item,
